  ...
  return (
    ...
    >
      ...
      <p>
        ...
        belonging to Japan Tour. Certain features of the Site may be subject to
      ...
      <p>
        <strong>Cookies and Web Beacons.</strong> Like any other website, Japan
        Tour uses ‘cookies'. These cookies are used to store information
      ...
      <p>
        ...
        the Company should be sent to: japantour.site. After the Notice is
      ...
      <strong>Email: japantoursite@gmail.com</strong>
    </Container>
  );
};
