...
exports.up = async function (knex) {
  await knex.schema.createTable("PlaceInfoZhTW", (table) => {
  ...
  await knex.raw(ON_UPDATE_TIMESTAMP_TRIGGER("PlaceInfoZhTW"));
};
...
exports.down = async function (knex) {
  await knex.schema.dropTableIfExists("PlaceInfoZhTW");
  await knex.raw(DROP_ON_UPDATE_TIMESTAMP_TRIGGER("PlaceInfoZhTW"));
};
